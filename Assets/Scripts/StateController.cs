...
public class StateController : MonoBehaviour
{
    ...
    private void Win()
    {
        ...
        Cursor.visible = true;
        AudioManager.PlayMusic(AudioManager.winScreenMusic);
        PauseLock = true;
        FreezeState();
    ...
    private void Lose()
    {
        ...
        Cursor.lockState = CursorLockMode.None;
        Cursor.visible = true;
        AudioManager.PlayMusic(AudioManager.gameOverScreenMusic);
        PauseLock = true;
        FreezeState();
